package com.xhateya.idn.weatherapp
...
import com.xhateya.idn.weatherapp.Constants.API_KEY
import com.xhateya.idn.weatherapp.Constants.METRIC_UNIT
import com.xhateya.idn.weatherapp.models.WeatherResponse
import com.xhateya.idn.weatherapp.network.WeatherConfig
...
@SuppressLint("MissingPermission")
    ...
    private fun setupUI(responseBody: WeatherResponse){
        for (i in responseBody.weather.indices){
            ...
            val tvVisibility: TextView= findViewById(R.id.tv_wind)
